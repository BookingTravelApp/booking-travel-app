...
router.post('/avatar' , verifyToken ,upload.singleUpload.single('avatar') , async(req, res) => {
    ...
    if(filename) {
        try {
            ...
            if(require('fs').existsSync(filepath)){
                ...
                return res.sendFile( `${__basedir}\\public\\upload\\avatar\\${DEFAULT_USER_PIC}`);
            }
...
router.post('/media', verifyToken ,upload.multipleUpload ,async(req, res) => {
